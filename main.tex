...
Let us see that how to apply this to solve \Cref{eqn:hitchin}.
...
But $\psi$ is non-zero and its determinant is constant along the fibers of $E$, so we only have the following two possibilities:
\begin{itemize}
