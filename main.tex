...
It follows from this and the discussion in \cite[\S 4]{hit87a} or in \cite[\S 8]{ab82} that if we manage to find a minimum of for
\[ f(\nabla,\Phi):=\int_{M}||\mu(\nabla,\Phi)||^{2} \]
...
This is always possible by definition of infimum and convexity of $f$ \cite[\S 8]{ab82}.
