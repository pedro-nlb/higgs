...
The condition $\nabla^{0,1}\Phi=0$ then translates into $\Phi$ being a holomorphic section of $\End(E)\ot K$, which can be regarded as a holomorphic morphism $E\to E\ot K$.
...
\begin{unota}
    For $E\in \Vec_{2}(M)$, denote by $\End_{0}(E)$ the vector bundle of traceless endomorphisms of $E$.
\end{unota}
