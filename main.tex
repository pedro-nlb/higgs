...
\begin{prop}
	...
	There must be some non-zero eigenvector outside of $L$, call it $v'\in V$.
	\todo{Make this precise. We could have some nilpotent matrix, for example. Can we avoid this?}
	...
	By \cite[Exercise II.7.9]{har77} we can write $\M_{i}\cong p^{*}\L_{i}(l_{i})$ with $l_{1}+l_{2}=2$.
