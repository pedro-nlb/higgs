...
\begin{prop}
	...
	\[
	    \begin{pmatrix}
		\mu\lambda_{e_{1}}^{\beta}l_{1} & \mu\lambda_{e_{2}}^{\beta}l_{2} \\
	...
	A non-zero Higgs field in this subbundle leaves only $L$ invariant, because the inclusion $L^{2}\ot \Lambda^{2}E\dual \subseteq \Hom(E,E)$ factors through $\Hom(E,L)\subseteq \Hom(E,E)$, as we have seen a moment ago.
    \end{proof}
\end{prop}
